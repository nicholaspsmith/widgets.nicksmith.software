...
save(CharacterIcon.chameleon(color: .systemGreen, tail: true, tongue: true), "icon-vpn-dns.png")
...
save(CharacterIcon.rocket(level: 0.6, online: true), "icon-apollo-monitor.png")
...
strip([CharacterIcon.rocket(level: 0.2, online: true), CharacterIcon.rocket(level: 0.8, online: true), CharacterIcon.rocket(level: 0.5, online: false)], "states-apollo-monitor.png")
